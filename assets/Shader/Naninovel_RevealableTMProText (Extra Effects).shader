...
void main()
{
    ...
    vs_TEXCOORD6.xy = u_xlat0.xy * _FaceTex_ST.xy + _FaceTex_ST.zw;
    vs_TEXCOORD6.zw = u_xlat0.xy * _OutlineTex_ST.xy + _OutlineTex_ST.zw;
    return;
}
...
void main()
{
    ...
    u_xlat6 = u_xlat16_0.x + (-vs_TEXCOORD1.x);
    ...
    u_xlat0.xy = vec2(_OutlineUVSpeedX, _OutlineUVSpeedY) * _Time.yy + vs_TEXCOORD6.zw;
    u_xlat16_0 = texture(_OutlineTex, u_xlat0.xy);
    u_xlat2 = u_xlat16_0 * _OutlineColor;
    u_xlat16_3.xyz = vs_COLOR0.xyz * _FaceColor.xyz;
    u_xlat0.xy = vec2(_FaceUVSpeedX, _FaceUVSpeedY) * _Time.yy + vs_TEXCOORD6.xy;
    ...
    u_xlat10 = u_xlat4.x * vs_TEXCOORD1.y;
    u_xlat16_1 = u_xlat4.x * vs_TEXCOORD1.y + 1.0;
    u_xlat16_7 = u_xlat10 * 0.5 + u_xlat16_7;
    u_xlat16_1 = u_xlat16_7 / u_xlat16_1;
    u_xlat16_1 = clamp(u_xlat16_1, 0.0, 1.0);
    u_xlat16_1 = (-u_xlat16_1) + 1.0;
    u_xlat16_0 = u_xlat16_0 * vec4(u_xlat16_1);
    u_xlatb4.xy = greaterThanEqual(vs_TEXCOORD4.xyxx, _LineClipRect.xyxx).xy;
    u_xlatb4.zw = greaterThanEqual(_LineClipRect.zzzw, vs_TEXCOORD4.xxxy).zw;
...
;
    ...
    u_xlat4.x = (-_CharSlantAngle) * 0.0174532924 + 1.57079506;
    u_xlat5 = cos(u_xlat4.x);
    u_xlat4.x = sin(u_xlat4.x);
    u_xlat4.x = u_xlat4.x / u_xlat5;
    u_xlat10 = vs_TEXCOORD4.y + (-_CharClipRect.y);
    u_xlat4.x = u_xlat10 / u_xlat4.x;
    u_xlat10 = (-vs_TEXCOORD4.x) + _CharClipRect.x;
    u_xlat4.x = u_xlat4.x + u_xlat10;
    u_xlat4.x = u_xlat4.x / _CharFadeWidth;
    u_xlat4.x = clamp(u_xlat4.x, 0.0, 1.0);
    u_xlat1 = u_xlat0 * u_xlat4.xxxx;
    u_xlatb4.x = vs_TEXCOORD4.y<_CharClipRect.w;
    u_xlat16_0 = (u_xlatb4.x) ? u_xlat1 : u_xlat0;
...
;
    ...
    u_xlatb4.x = vs_TEXCOORD4.y<_CharClipRect.w;
    u_xlat16_0 = (u_xlatb4.x) ? u_xlat1 : u_xlat0;
    u_xlat16_3.x = u_xlat16_0.w + -0.00100000005;
    SV_Target0 = u_xlat16_0 * vs_COLOR0.wwww;
