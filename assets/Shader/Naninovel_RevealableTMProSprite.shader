...
;
    ...
    u_xlatb2 = vs_TEXCOORD1.y<_CharClipRect.w;
...
void main()
{
    ...
    u_xlat0.x = sin(u_xlat0.x);
    u_xlat0.x = u_xlat0.x / u_xlat1.x;
    u_xlat4.x = vs_TEXCOORD1.y + (-_CharClipRect.y);
    u_xlat0.x = u_xlat4.x / u_xlat0.x;
    u_xlat4.x = (-vs_TEXCOORD1.x) + _CharClipRect.x;
    u_xlat0.x = u_xlat0.x + u_xlat4.x;
    u_xlat0.x = u_xlat0.x / _CharFadeWidth;
    u_xlat0.x = clamp(u_xlat0.x, 0.0, 1.0);
    u_xlatb4.xy = greaterThanEqual(vs_TEXCOORD1.xyxx, _LineClipRect.xyxx).xy;
...
;
    ...
    u_xlat0 = u_xlat0.xxxx * u_xlat1;
    u_xlatb2 = vs_TEXCOORD1.y<_CharClipRect.w;
    u_xlat16_0 = (bool(u_xlatb2)) ? u_xlat0 : u_xlat1;
    u_xlat16_3 = u_xlat16_0.w + -0.00100000005;
...
void main()
{
    u_xlatb0.xy = greaterThanEqual(vs_TEXCOORD1.xyxx, _LineClipRect.xyxx).xy;
    u_xlatb0.zw = greaterThanEqual(_LineClipRect.zzzw, vs_TEXCOORD1.xxxy).zw;
...
;
    ...
    u_xlat1 = u_xlat16_1 + _TextureSampleAdd;
    u_xlat1 = u_xlat1 * vs_COLOR0;
    u_xlat1.w = u_xlat3.x * u_xlat1.w;
    u_xlat0 = u_xlat0.xxxx * u_xlat1;
    u_xlat1.x = (-_CharSlantAngle) * 0.0174532924 + 1.57079506;
    u_xlat2 = cos(u_xlat1.x);
    u_xlat1.x = sin(u_xlat1.x);
    u_xlat1.x = u_xlat1.x / u_xlat2;
    u_xlat4 = vs_TEXCOORD1.y + (-_CharClipRect.y);
    u_xlat1.x = u_xlat4 / u_xlat1.x;
    u_xlat4 = (-vs_TEXCOORD1.x) + _CharClipRect.x;
    u_xlat1.x = u_xlat1.x + u_xlat4;
    u_xlat1.x = u_xlat1.x / _CharFadeWidth;
...
;
    ...
    u_xlat1 = u_xlat16_1 + _TextureSampleAdd;
    u_xlat1 = u_xlat1 * vs_COLOR0;
    u_xlat1.w = u_xlat4.x * u_xlat1.w;
    u_xlat0 = u_xlat0.xxxx * u_xlat1;
    u_xlat1.x = (-_CharSlantAngle) * 0.0174532924 + 1.57079506;
    u_xlat2 = cos(u_xlat1.x);
    u_xlat1.x = sin(u_xlat1.x);
    u_xlat1.x = u_xlat1.x / u_xlat2;
    u_xlat5 = vs_TEXCOORD1.y + (-_CharClipRect.y);
    u_xlat1.x = u_xlat5 / u_xlat1.x;
    u_xlat5 = (-vs_TEXCOORD1.x) + _CharClipRect.x;
    u_xlat1.x = u_xlat1.x + u_xlat5;
    u_xlat1.x = u_xlat1.x / _CharFadeWidth;
    u_xlat1.x = clamp(u_xlat1.x, 0.0, 1.0);
    u_xlat1 = u_xlat0 * u_xlat1.xxxx;
    u_xlatb2 = vs_TEXCOORD1.y<_CharClipRect.w;
    u_xlat16_0 = (bool(u_xlatb2)) ? u_xlat1 : u_xlat0;
    u_xlat16_3 = u_xlat16_0.w + -0.00100000005;
    SV_Target0 = u_xlat16_0;
    u_xlatb1.x = u_xlat16_3<0.0;
    if(u_xlatb1.x){discard;}
