...
void main()
{
    ...
    u_xlat4.xy = vs_TEXCOORD3.xy + (-_CharClipRect.zy);
...
void main()
{
    ...
    u_xlat16_5 = u_xlat16_0.x * vs_TEXCOORD1.x + (-vs_TEXCOORD1.w);
    u_xlat16_5 = clamp(u_xlat16_5, 0.0, 1.0);
    u_xlat16_0 = vec4(u_xlat16_5) * vs_COLOR0;
    u_xlat16_0 = vec4(u_xlat16_1) * u_xlat16_0;
    u_xlatb2.xy = greaterThanEqual(vs_TEXCOORD3.xyxx, _LineClipRect.xyxx).xy;
    u_xlatb2.zw = greaterThanEqual(_LineClipRect.zzzw, vs_TEXCOORD3.xxxy).zw;
...
;
    ...
    u_xlat2.x = (-_CharSlantAngle) * 0.0174532924 + 1.57079506;
    u_xlat3 = cos(u_xlat2.x);
    u_xlat2.x = sin(u_xlat2.x);
    u_xlat2.x = u_xlat2.x / u_xlat3;
    u_xlat6.xy = vs_TEXCOORD3.xy + (-_CharClipRect.zy);
    u_xlat2.x = u_xlat6.y / u_xlat2.x;
    u_xlat2.x = u_xlat2.x + u_xlat6.x;
    u_xlat2.x = u_xlat2.x / _CharFadeWidth;
    u_xlat2.x = clamp(u_xlat2.x, 0.0, 1.0);
    u_xlat1 = u_xlat0 * u_xlat2.xxxx;
    u_xlatb2.x = vs_TEXCOORD3.y<_CharClipRect.w;
...
;
    ...
    u_xlat2.x = sin(u_xlat2.x);
    u_xlat2.x = u_xlat2.x / u_xlat3;
    u_xlat7.xy = vs_TEXCOORD3.xy + (-_CharClipRect.zy);
    ...
    u_xlat1 = u_xlat0 * u_xlat2.xxxx;
    u_xlatb2.x = vs_TEXCOORD3.y<_CharClipRect.w;
    u_xlat16_0 = (u_xlatb2.x) ? u_xlat1 : u_xlat0;
    u_xlat16_4 = u_xlat16_0.w + -0.00100000005;
    SV_Target0 = u_xlat16_0;
