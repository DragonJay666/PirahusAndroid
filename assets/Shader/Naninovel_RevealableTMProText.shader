...
void main()
{
    u_xlat0.x = (-_CharSlantAngle) * 0.0174532924 + 1.57079506;
    u_xlat1.x = cos(u_xlat0.x);
    u_xlat0.x = sin(u_xlat0.x);
    u_xlat0.x = u_xlat0.x / u_xlat1.x;
    u_xlat4.x = vs_TEXCOORD3.y + (-_CharClipRect.y);
    u_xlat0.x = u_xlat4.x / u_xlat0.x;
    u_xlat4.x = (-vs_TEXCOORD3.x) + _CharClipRect.x;
    u_xlat0.x = u_xlat0.x + u_xlat4.x;
    u_xlat0.x = u_xlat0.x / _CharFadeWidth;
    u_xlat0.x = clamp(u_xlat0.x, 0.0, 1.0);
    u_xlatb4.xy = greaterThanEqual(vs_TEXCOORD3.xyxx, _LineClipRect.xyxx).xy;
    u_xlat4.x = u_xlatb4.x ? float(1.0) : 0.0;
    u_xlat4.y = u_xlatb4.y ? float(1.0) : 0.0;
;
    u_xlatb1.xy = greaterThanEqual(_LineClipRect.zwzz, vs_TEXCOORD3.xyxx).xy;
    u_xlat1.x = u_xlatb1.x ? float(1.0) : 0.0;
    u_xlat1.y = u_xlatb1.y ? float(1.0) : 0.0;
;
    u_xlat4.xy = u_xlat4.xy * u_xlat1.xy;
    u_xlat4.x = (-u_xlat4.x) * u_xlat4.y + 1.0;
    u_xlat16_8 = texture(_MainTex, vs_TEXCOORD0.xy).w;
    u_xlat16_2 = u_xlat16_8 * vs_TEXCOORD1.x + (-vs_TEXCOORD1.w);
    u_xlat16_2 = clamp(u_xlat16_2, 0.0, 1.0);
    u_xlat16_1 = vec4(u_xlat16_2) * vs_COLOR0;
    u_xlat1 = u_xlat4.xxxx * u_xlat16_1;
    u_xlat0 = u_xlat0.xxxx * u_xlat1;
    u_xlatb3 = vs_TEXCOORD3.y<_CharClipRect.w;
    SV_Target0 = (bool(u_xlatb3)) ? u_xlat0 : u_xlat1;
    return;
}
...
void main()
{
    ...
    vs_TEXCOORD4.xy = u_xlat8.xz + in_TEXCOORD0.xy;
...
void main()
{
    u_xlat16_0.x = texture(_MainTex, vs_TEXCOORD4.xy).w;
    u_xlat16_1 = u_xlat16_0.x * vs_TEXCOORD5.x + (-vs_TEXCOORD5.y);
    ...
    u_xlat0 = u_xlat0 * vs_TEXCOORD4.zzzz;
    u_xlatb3.xy = greaterThanEqual(vs_TEXCOORD3.xyxx, _LineClipRect.xyxx).xy;
    u_xlatb3.zw = greaterThanEqual(_LineClipRect.zzzw, vs_TEXCOORD3.xxxy).zw;
...
;
    ...
    u_xlat3.x = (-_CharSlantAngle) * 0.0174532924 + 1.57079506;
    u_xlat4 = cos(u_xlat3.x);
    u_xlat3.x = sin(u_xlat3.x);
    u_xlat3.x = u_xlat3.x / u_xlat4;
    u_xlat8 = vs_TEXCOORD3.y + (-_CharClipRect.y);
    u_xlat3.x = u_xlat8 / u_xlat3.x;
    u_xlat8 = (-vs_TEXCOORD3.x) + _CharClipRect.x;
    u_xlat3.x = u_xlat3.x + u_xlat8;
    u_xlat3.x = u_xlat3.x / _CharFadeWidth;
    u_xlat3.x = clamp(u_xlat3.x, 0.0, 1.0);
    u_xlat1 = u_xlat0 * u_xlat3.xxxx;
    u_xlatb3.x = vs_TEXCOORD3.y<_CharClipRect.w;
    SV_Target0 = (u_xlatb3.x) ? u_xlat1 : u_xlat0;
    return;
}
...
;
    ...
    u_xlat0 = u_xlat0.xxxx * u_xlat1;
    u_xlatb3 = vs_TEXCOORD3.y<_CharClipRect.w;
    u_xlat16_0 = (bool(u_xlatb3)) ? u_xlat0 : u_xlat1;
...
;
    ...
    u_xlat3.x = sin(u_xlat3.x);
    u_xlat3.x = u_xlat3.x / u_xlat4;
    u_xlat9 = vs_TEXCOORD3.y + (-_CharClipRect.y);
    u_xlat3.x = u_xlat9 / u_xlat3.x;
    u_xlat9 = (-vs_TEXCOORD3.x) + _CharClipRect.x;
    u_xlat3.x = u_xlat3.x + u_xlat9;
    u_xlat3.x = u_xlat3.x / _CharFadeWidth;
    u_xlat3.x = clamp(u_xlat3.x, 0.0, 1.0);
    u_xlat1 = u_xlat0 * u_xlat3.xxxx;
    u_xlatb3.x = vs_TEXCOORD3.y<_CharClipRect.w;
    u_xlat16_0 = (u_xlatb3.x) ? u_xlat1 : u_xlat0;
    u_xlat16_5 = u_xlat16_0.w + -0.00100000005;
    SV_Target0 = u_xlat16_0;
    u_xlatb3.x = u_xlat16_5<0.0;
...
void main()
{
    ...
    u_xlat16_2 = u_xlat4.y * u_xlat4.x;
    u_xlat16_4 = texture(_MainTex, vs_TEXCOORD0.xy).w;
    u_xlat16_6 = u_xlat16_4 * vs_TEXCOORD1.x + (-vs_TEXCOORD1.w);
    u_xlat16_6 = clamp(u_xlat16_6, 0.0, 1.0);
    u_xlat16_1 = vec4(u_xlat16_6) * vs_COLOR0;
    u_xlat16_1 = vec4(u_xlat16_2) * u_xlat16_1;
    u_xlatb4.xy = greaterThanEqual(vs_TEXCOORD3.xyxx, _LineClipRect.xyxx).xy;
    u_xlat4.x = u_xlatb4.x ? float(1.0) : 0.0;
    u_xlat4.y = u_xlatb4.y ? float(1.0) : 0.0;
;
    u_xlatb3.xy = greaterThanEqual(_LineClipRect.zwzz, vs_TEXCOORD3.xyxx).xy;
    u_xlat3.x = u_xlatb3.x ? float(1.0) : 0.0;
    u_xlat3.y = u_xlatb3.y ? float(1.0) : 0.0;
;
    ...
    u_xlat0 = u_xlat0.xxxx * u_xlat1;
    u_xlatb3.x = vs_TEXCOORD3.y<_CharClipRect.w;
    SV_Target0 = (u_xlatb3.x) ? u_xlat0 : u_xlat1;
    return;
}
...
void main()
{
    ...
    u_xlat0 = u_xlat16_0 * vs_TEXCOORD4.zzzz;
    u_xlatb3.xy = greaterThanEqual(vs_TEXCOORD3.xyxx, _LineClipRect.xyxx).xy;
    u_xlatb3.zw = greaterThanEqual(_LineClipRect.zzzw, vs_TEXCOORD3.xxxy).zw;
    u_xlat3.x = u_xlatb3.x ? float(1.0) : 0.0;
    u_xlat3.y = u_xlatb3.y ? float(1.0) : 0.0;
